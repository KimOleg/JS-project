Цель проекта - полноценное приложение в браузере, написанное на JS. Приложение представляет из себя web-интерфейс для CRM системы со следующими возмозностями:
